                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="second_last_name" name="second_last_name" class="form-control"
                                            value="{{ old('second_last_name') ?? $object->second_last_name }}">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="role_id" name="role_id" class="form-control select2" data-width="100%" required>
                                        ...
                                        @foreach($roles as $role)
                                            <option value="{{ $role->id }}" {{old('role_id') ? $role->id == old('role_id') ? 'selected':'' : $role->id == $object->roles[0]->id ? 'selected':'' }}>{{ $role->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
