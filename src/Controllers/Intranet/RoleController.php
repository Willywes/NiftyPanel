...
class RoleController extends GlobalController
{
    ...
    {
        $objects = Role::all()->except([1, 2001, 2002]);
    ...
    {
        $permissions = Permission::where('guard_name', 'intranet')->get();
    ...
    public function edit($id)
    {
        ...
        $permissions = Permission::where('guard_name', $object->guard_name)->get();
        $groups = $permissions->pluck('public_group')->unique();
