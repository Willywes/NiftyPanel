...
class CreatePermissionTables extends Migration
{
    ...
    function load()
    {
        ...
        Spatie\Permission\Models\Permission::create([
            'name' => 'intranet.users.permissionsEdit',
            'public_group' => 'Usuarios',
            'public_name' => 'Ver permisos usuarios',
            'public_description' => 'Permite ver los permisos del usuarios.',
            //   'controller' => \App\Http\Controllers\Intranet\UserController::class,
        ]);

        Spatie\Permission\Models\Permission::create([
            'name' => 'intranet.users.permissionsUpdate',
            'public_group' => 'Usuarios',
            'public_name' => 'Editar los permisos usuarios',
            'public_description' => 'Permite editar los permisos de usuarios.',
            //   'controller' => \App\Http\Controllers\Intranet\UserController::class,
        ]);
